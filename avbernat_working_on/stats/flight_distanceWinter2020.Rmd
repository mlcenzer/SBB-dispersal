...
source("generic models-Gamma glmer 3-FF log link.R") # 9 models failed to converge
...
source("AICprobabilities.R")
source("generic models-Gamma glmer 4-FF log link.R") # most models failed to converge
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
source("AICprobabilities.R")
source("generic models-Gamma glmer 3-FF log link.R") # about 3 models failed to converge
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
