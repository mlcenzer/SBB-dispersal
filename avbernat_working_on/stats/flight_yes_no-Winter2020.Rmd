...
source("src/generic models-binomial glm 3-FF.R")
...
```{r}
source("src/AICprobabilities.R")
source("src/generic models-binomial glm 4-FF.R")
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
- m61 <-glm(formula = R ~ A * C + C * D + B, family = binomial, data = data)
...
- m54 <- glm(formula = R ~ B * D + C * D, family = binomial, data = data)
...
source("src/AICprobabilities.R")
source("src/generic models-binomial glm 2-FF.R")
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
source("src/AICprobabilities.R")
source("src/generic models-binomial glmer 1 RF + 3-FF.R") # 3 models didn't converge
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
source("src/AICprobabilities.R")
source("src/generic models-binomial glmer 1-RF + 4-FF.R")
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
source("src/AICprobabilities.R")
source("src/generic models-binomial glmer 1 RF + 3-FF.R")
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
source("src/AICprobabilities.R")
source("src/generic models-binomial glmer 2 RF + 3-FF.R")
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
source("src/AICprobabilities.R")
source("src/generic models-binomial glmer 2-RF + 2-FF.R")
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
...
source("src/AICprobabilities.R")
source("src/generic models-binomial glmer 2-RF + 1-FF.R")
AICs <- sort(summary$AIC)
models_init <- sort(P, decreasing=TRUE, index.return=TRUE)
top <- length(models_init$x[which(models_init$x>0.05)])
