...
length(errors$warnings) # 7 models did not converge
```
...
* no effect of host
* no effect of host*sex - would be more marginal (p=0.1) where if F and from GRT then more likely to fly,
...
####### Effect of test date (as seen in the data_all and marginally in females)
