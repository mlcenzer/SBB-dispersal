...
# VIF = variance in inflation factor: it detects multicollinearity
# in regression analysis (aka. correlation between predictors)
# **The VIF estimates how much the variance of a regression 
# coefficient is inflated due to multicollinearity in the model.
# 1 = not correlatied
# 1 to 5 = moderately correlated
# >5 = highly correlated
# In general, a VIF above 10 indicates high correlation and 
