...
datapath = "/Users/anastasiabernat/Desktop/full_data/"
...
for file in dir_list:
    ...
    header = ['ID', 'filename', 'channel_num', 'channel_letter', 'chamber',
    ...
    drop_columns = ['ID', 'filename', 'channel_num', 'channel_letter', 'chamber', 'set_number',
             'total_duration', 'box', 'test_date', 'time_start', 'died?', 'flight_details',
             'NOTES', 'time_end']
