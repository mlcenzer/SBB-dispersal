...
def flying_bouts(time, speed, ch):
    ...
    if len(time) > 2:
        ...
        fly_time=flight_time/1800          #total recording time defined by the user 
...
input_file = open(r"C:\Users\labadmin\Desktop\Dispersal Project 2019\standardized_peaks.txt" + filename, "r")
