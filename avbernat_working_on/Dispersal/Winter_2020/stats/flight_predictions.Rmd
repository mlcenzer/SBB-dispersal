...
plot(d$mass_diff, T1_rather_than_none, ylim=c(0,1), col="blue", type="l",
     ylab="Flight Case Probability", xlab="Change in Mass From T1 to T2 (g)", lty=1) #T1 only
...
plot(d$mass_diff[egg2], T1_rather_than_none[egg2], ylim=c(0,1), col="blue", type="l",
     ylab="Flight Case Probability", xlab="Change in Mass From T1 to T2 (g)", lty=2) #T1 only
