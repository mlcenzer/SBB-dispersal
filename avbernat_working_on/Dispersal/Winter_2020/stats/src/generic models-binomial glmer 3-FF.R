...
m18<-glmer(R~A + (1|X), family=binomial, data=data)

m19<-glmer(R~B + (1|X), family=binomial, data=data)

m20<-glmer(R~C + (1|X), family=binomial, data=data)

m21<-glmer(R~A+B + (1|X), family=binomial, data=data)

m22<-glmer(R~A+C + (1|X), family=binomial, data=data)

m23<-glmer(R~B+C + (1|X), family=binomial, data=data)

m24<-glmer(R~A+B+C + (1|X), family=binomial, data=data)

m25<-glmer(R~A*B + (1|X), family=binomial, data=data)

m26<-glmer(R~A*C + (1|X), family=binomial, data=data)

m27<-glmer(R~B*C + (1|X), family=binomial, data=data)

m28<-glmer(R~A*B + C + (1|X), family=binomial, data=data)

m29<-glmer(R~A*C + B + (1|X), family=binomial, data=data)

m30<-glmer(R~B*C + A + (1|X), family=binomial, data=data)

m31<-glmer(R~A*B + A*C + (1|X), family=binomial, data=data)

m32<-glmer(R~A*B + B*C + (1|X), family=binomial, data=data)

m33<-glmer(R~A*C + B*C + (1|X), family=binomial, data=data)

m34<-glmer(R~A*B + A*C + B*C + (1|X), family=binomial, data=data)
