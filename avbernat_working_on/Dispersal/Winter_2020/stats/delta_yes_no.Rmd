...
prediction_equations2 = function(tb) {
  ...
  M = (tb[1,2] - tb[2,2])
  S = (tb[1,3] - tb[2,3])
  EQ1 = paste0("log(pi_-1 / pi_1) = ", round(I, 2), " + ", round(M,2), " Mass Change", " + ", round(S, 2), " Sex ", "     Flew in T1, rather than T2" )
  
  # 2 / -1 | Flew in both, not T1
  I = (tb[3,1] - tb[1,1])
  M = (tb[3,2] - tb[1,2])
  S = (tb[3,3] - tb[1,3])
  EQ2 = paste0("log(pi_2 / pi_-1) = ", round(I, 2), " + ", round(M,2), " Mass Change", " + ", round(S, 2), " Sex ", "     Flew in both, rather than T1" )
  
  # 2 / 1 | Flew in both, not T2
  I = (tb[3,1] - tb[2,1])
  M = (tb[3,2] - tb[2,2])
  S = (tb[3,3] - tb[2,3])
  EQ3 = paste0("log(pi_2 / pi_1) = ", round(I, 2), " + ", round(M,2),  " Mass Change", " + ", round(S, 2), " Sex ", "     Flew in both, rather than T2")
...
```{r}
gsub("Mass Change",  "Mass Percent Change", prediction_equations2(model_table))
```
