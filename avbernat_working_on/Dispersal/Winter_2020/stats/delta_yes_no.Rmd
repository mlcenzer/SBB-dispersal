...
df$flight_case <- relevel(as.factor(df$flight_case), ref = "2")
```
...
get_significant_models = function(){
  ...
  for (i in baselines) {
    ...
    model <- multinom(flight_case ~ mass_diff, trace=FALSE, data = df) 
    model_table = calculate_P(model, print_table=FALSE)
    cat("Baseline is: ", i, "\n")
    ...
    for (e in eqs){
      c = c + 1
      e = as.integer(e) + 2 
      #cat("row: ", r, "   col:", e, "    pval: ", model_table[c,7], "     true col:",e - 2, "\n")
    ...
    for (i in 1:length(pvals)){
      if (pvals[i] > 0.05) {
        cat("\tEquation is", eqs[i], "\tP is", pvals[i], "\n")
      }
    }
  }
  
  cat("\nBaselines are the rows and the equations are the columns. \n")
...
# summary table (similar to lm, glm, or lmer function)
model_table <- cbind(s$coefficients, c(s$edf, s$edf), s$standard.errors[,2:4], z[,2:4], wald[,2:4], p[,2:4])
...
plot(df$mass_per[Frows], pp[Frows,1], ylim=c(0,1), xlim=c(-40,104), col="red",type="l", 
     ylab="Flight Case Probability", xlab="Percent Change in Mass From T1 to T2 (%)", main="Females - including wing2body", lty=1) # flew in T1 but not T2
points(df$mass_per[Frows], pp[Frows,2], col="blue", type="l") # did not fly in either
#points(df$mass_per[Frows], pp[Frows,3], col="darkgreen", cex=0.45, type="l", pch=16) # flew in T2 but not T1
points(df$mass_per[Frows], pp[Frows,4], col="darkred", type="l") # flew in both
text(68,0.7, labels="Flew in T1 only", col="blue")
text(-27,0.95, labels="Did Not Fly", col="red")
...
points(df$mass_per[lrows], pp[lrows,1], col="red", type="p", cex=0.45, pch=16)
points(df$mass_per[srows], pp[srows,1], col="red", type="p", cex=0.45) # those with smaller wing2body ratio were more likely to NOT fly
points(df$mass_per[lrows], pp[lrows,2], col="blue", type="p", cex=0.45, pch=16)
points(df$mass_per[srows], pp[srows,2], col="blue", type="p", cex=0.45) 
points(df$mass_per[lrows], pp[lrows,4], col="darkred", type="p", cex=0.45, pch=16)
points(df$mass_per[srows], pp[srows,4], col="darkred", type="p", cex=0.45) 
```

```{r echo=FALSE}
plot(df$mass_per[Mrows], pp[Mrows,1], ylim=c(0,0.8), xlim=c(-25,85), col="red",type="l", 
     ylab="Flight Case Probability", xlab="Percent Change in Mass From T1 to T2 (%)", main="Males - including wing2body", lty=1)
...
text(73,0.42, labels="Flew in T1 only", col="blue")
text(70,0.1, labels="Did Not Fly", col="red")
text(73,0.02, labels="Flew in T2 only", col="darkgreen")
text(13,0.77, labels="Flew Twice", col="darkred")
...
points(df$mass_per[lrows], pp[lrows,2], col="blue", type="p", cex=0.45, pch=16)
points(df$mass_per[srows], pp[srows,2], col="blue", type="p", cex=0.45) 
points(df$mass_per[lrows], pp[lrows,3], col="darkgreen", type="p", cex=0.45, pch=16)
points(df$mass_per[srows], pp[srows,3], col="darkgreen", type="p", cex=0.45) 
points(df$mass_per[lrows], pp[lrows,4], col="darkred", type="p", cex=0.45, pch=16)
points(df$mass_per[srows], pp[srows,4], col="darkred", type="p", cex=0.45) 
```
...
```{r echo=FALSE}
plot(df6$mass_per[Frows], pp6[Frows,1], ylim=c(0,1), xlim=c(-40,104), col="red",type="l", 
     ylab="Flight Case Probability", xlab="Percent Change in Mass From T1 to T2 (%)", main="Females - including wing2body", lty=1) # flew in T1 but not T2
points(df6$mass_per[Frows], pp6[Frows,2], col="blue", type="l") # did not fly in either
points(df6$mass_per[Frows], pp6[Frows,4], col="darkred", type="l") # flew in both
text(68,0.7, labels="Flew in T1 only", col="blue")
text(-27,0.95, labels="Did Not Fly", col="red")
text(-31,0.37, labels="Flew Twice", col="darkred")

# Mark points in the graph with high wing2body ratio vs. points with low wing2body ratio.
test <- df6[with(df6, order(wing2body)),] # ascending order
#test$index
...
points(df6$mass_per[lrows], pp6[lrows,1], col="red", type="p", cex=0.45, pch=16)
points(df6$mass_per[srows], pp6[srows,1], col="red", type="p", cex=0.45) # those with smaller wing2body ratio were more likely to NOT fly
points(df6$mass_per[lrows], pp6[lrows,2], col="blue", type="p", cex=0.45, pch=16)
points(df6$mass_per[srows], pp6[srows,2], col="blue", type="p", cex=0.45) 
points(df6$mass_per[lrows], pp6[lrows,4], col="darkred", type="p", cex=0.45, pch=16)
points(df6$mass_per[srows], pp6[srows,4], col="darkred", type="p", cex=0.45) 
```

```{r echo=FALSE}
plot(df6$mass_per[Mrows], pp6[Mrows,1], ylim=c(0,0.8), xlim=c(-25,85), col="red",type="l", 
     ylab="Flight Case Probability", xlab="Percent Change in Mass From T1 to T2 (%)", main="Males - including wing2body", lty=1)
points(df6$mass_per[Mrows], pp6[Mrows,2], col="blue", type="l", cex=0.45, lty=1)
points(df6$mass_per[Mrows], pp6[Mrows,3], col="darkgreen", type="l", cex=0.45, lty=1) 
points(df6$mass_per[Mrows], pp6[Mrows,4], col="darkred", type="l", cex=0.45, lty=1) 
text(73,0.42, labels="Flew in T1 only", col="blue")
text(70,0.1, labels="Did Not Fly", col="red")
text(73,0.02, labels="Flew in T2 only", col="darkgreen")
text(13,0.77, labels="Flew Twice", col="darkred")
...
points(df6$mass_per[lrows], pp6[lrows,2], col="blue", type="p", cex=0.45, pch=16)
points(df6$mass_per[srows], pp6[srows,2], col="blue", type="p", cex=0.45) 
points(df6$mass_per[lrows], pp6[lrows,3], col="darkgreen", type="p", cex=0.45, pch=16)
points(df6$mass_per[srows], pp6[srows,3], col="darkgreen", type="p", cex=0.45) 
points(df6$mass_per[lrows], pp6[lrows,4], col="darkred", type="p", cex=0.45, pch=16)
points(df6$mass_per[srows], pp6[srows,4], col="darkred", type="p", cex=0.45) 
```
