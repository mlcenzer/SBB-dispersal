...
plot4 = function(df, pp, gradient=TRUE, circles=TRUE) {
  ...
  mtext("A. Females", side=3, adj=0.01, line=0.5, cex=1.5, font=2)
  text(68,0.7, labels="Flew in T1 only", col="blue")
...
plot5 = function(df, pp, gradient=TRUE, circles=TRUE) {
  c = 0.65
  plot(df$mass_per[Mrows], pp[Mrows,1], ylim=c(0,0.8), xlim=c(-25,81), col="red",type="l", 
  ...
  #text(-20,0.78, labels="Males", cex=1.5)
  mtext("B. Males", side=3, adj=0.01, line=0.5, cex=1.5, font=2)
  text(58,0.32, labels="Flew in T1 only", col="blue")
  text(58,0.17, labels="Did Not Fly", col="red")
  text(70,0.02, labels="Flew in T2 only", col="darkgreen")
  text(65,0.53, labels="Flew Twice", col="darkred") # 13,0.77
  if (circles) {
    legend(56.5, .81, 
         pch=c(16,1), 
         title="Wing-to-body", 
