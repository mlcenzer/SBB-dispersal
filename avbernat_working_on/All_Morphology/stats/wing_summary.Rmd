...
p10 = ggplot() + 
  ...
  ###MLC: Any data outside of this range in the geom_smooth dataset will be dropped (and thus mess up model predictions). I hope there is a way to fix this in ggplot, because this is very zoomed out.
  
  ylim(0.65, 0.85) +
  ####MLC: Solution to the ylim problem!
...
```{r echo=FALSE}
##MLC: This method of getting model predictions looks good to me.
