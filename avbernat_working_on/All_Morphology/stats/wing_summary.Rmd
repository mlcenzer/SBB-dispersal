...
```{r}
####MLC: I tested adding population as a parameter here - I think it gives a better view of the variability within host plants in the point plots.
###MLC: Came back and dropped population
...
###MLC: adding n to look at differences in sample rate
...
p9 = ggplot() + 
  ...
  scale_color_manual(values=c("Females" = sex_col_pts[1], "Males" = sex_col_pts[2])) +
  scale_fill_manual(values = c("Females" = sex_col_shade[1], "Males" = sex_col_shade[2])) +
  ###MLC: Note that the lower ylim value must be 0 or lower, or 0s in the data will be designated 'non-finite'
  ylim(0,1) +
  theme(legend.position = "none") 
