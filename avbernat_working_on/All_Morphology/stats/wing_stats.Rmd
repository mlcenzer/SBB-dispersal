...
raw_data[raw_data$year =="2019" & raw_data$month=="October",] #similar here. 260 bugs measured but 207 survived. So that means that 53 bugs did not survive and were still measured for morph. 
```
