...
```{r}
raw_data<-read.csv("data/allmorphology9.21.20.csv", header=TRUE, sep=",", quote="", stringsAsFactors=FALSE)
```
...
boxplot(wing2body~compare_dates,
        ...
        border="gray30",
        names=c("Past", "Winter 2020"), pch=1,
...
source("src/compare_models.R")
model_comparisonsAIC("src/generic models-gaussian glm 3-FF.R")
```
```{r}
