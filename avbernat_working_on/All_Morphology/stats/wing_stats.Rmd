...
* No more an effect of month_of_year effect. Before had a (+) effect of getting later in the season (month_of_year), such that long wing morphs become increasingly likely later in the year. 
