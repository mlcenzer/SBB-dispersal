...
points(Loc[,1], Loc[,2] + 10000000, col=2, cex=1) # not working utm vs. lat and long 
```
...
```{r}
data_source_name = "~/Desktop/git_repositories/SBB-dispersal/avbernat_working_on/All_Morphology/stats/data/shapefiles/Water.shp"
...
mesh.barrier$loc[,2] = mesh.barrier$loc[,2] + 10000000 # 10,000,000 off for some reason.........
Loc[,2] = Loc[,2] + 10000000
```
