...
check_stationarity(wing_mm) # this is not stationary
...
check_stationarity(wing_mmf) # barely not stationary | ACF and PACF significant here
addEventLines(events, pos=2, srt=90, col="red")
auto.arima(wing_mmf, stepwise=FALSE, approximation=FALSE)
```
...
addEventLines(events, pos=2, srt=90, col="red")
auto.arima(morphf, stepwise=FALSE, approximation=FALSE)
```
...
check_stationarity(wing_BV) # not stationary
addEventLines(events, pos=2, srt=90, col="red")
```
