...
filepath = r"/Users/anastasiabernat/Desktop/Flight trials_WinDAQ Recordings_Fall 2019/11am-10-15-19.txt"

filename = input("File path or file name -> ")
InputFile = open(filepath + filename, mode="r")
...
folderpath = r"/Users/anastasiabernat/Desktop/Test/standardized_peaks.txt"

OutputFile = open(folderpath, mode="w")
for i in range(0, len(Lines)):
