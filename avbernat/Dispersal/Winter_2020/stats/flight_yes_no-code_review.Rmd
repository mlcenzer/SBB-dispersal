...
#setwd("~/Documents/Florida soapberry project/2019 Dispersal/SBB-dispersal git/avbernat/stats") ####MLC: changed to my working directory
...
tidy_regression(glm(cbind(num_flew, num_notflew)~avg_mass, data=d, family=binomial), is_color=output_col) ####MLC: updated to binom
...
```{r}
mass_model <- lmer(num_flew ~ host_c * avg_mass + sex_c + (1|population), data=d)
