...
```{r echo=FALSE}
Fall = read.csv("/Users/anastasiabernat/Desktop/git_repositories/SBB-dispersal/avbernat_working_on/Dispersal/Autumn_2019/stats/data/full_data-Fall2019.csv")
...
kable(table2b, caption="Table 1. Field soapberry bugs collected and tested for flight trials.") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))  %>%
  add_header_above(c(" ", " ", " ", "Coordinates" = 2, "Sample Sizes" = 2 )) %>% 
