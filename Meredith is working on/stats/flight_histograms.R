...
hist((dist_summary$distance[dist_summary$host_c==-1]/1000), col=rgb(1,0.2,0,0.5), main='Soapberry bug dispersal fall 2019', breaks=seq(-0.001,4.999, by=0.5), xlab="Average distance (km)", freq=FALSE)
legend(3, 1, legend=c("Spatially clustered host", "Spatially unclustered host"), pch=15, col=c(rgb(0,1,1,0.5), rgb(1,0.2,0,0.5)))
#par(mar=c(4.8,4.9,0.1,0.1))
hist((dist_summary$distance[dist_summary$host_c==1]/1000), col=rgb(0,1,1, 0.5), breaks=seq(-0.001,4.999, by=0.5), add=TRUE, freq=FALSE)
